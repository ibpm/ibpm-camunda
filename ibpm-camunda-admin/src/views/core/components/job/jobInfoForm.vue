<template>
  <el-form
    ...
    class="form-layout"
  >
    <el-form-item :label="$t('core.job.columns.jobName')" prop="jobName">
      <el-input v-model="job.jobName" :placeholder="$t('core.job.placeholder.jobName')" />
    </el-form-item>
...
export default {
  ...
  methods: {
    setFormRules() {
      this.rules.jobName[0].message = this.$t('core.job.rules.jobName')
